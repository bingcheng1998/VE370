...
// ver 3.0: combine the v2 and the proof reading result.
	...
	// 2. add a new wire ID_EX_functPC_plus4_in, PC_plus4_out, instruction_in, instruction_out, IF_ID_Write, IF_Flush, clk, reset, and hence change the I/O of the stage register of ID_EX.
	// 3. change the connection of tPC_plus4_in, PC_plus4_out, instruction_in, instruction_out, IF_ID_Write, IF_Flush, clk, resethe 3to1 mux to make the structure 
	// of the connection parallel (aPC_plus4_in, PC_plus4_out, instruction_in, instruction_out, IF_ID_Write, IF_Flush, clk, resetnd hence easier to implement forwarding unit).
